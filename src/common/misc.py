...
def parse_args():
    ...
    parser.add_argument("--defaults", type=str, default="configs/templates/defaults.json", help="default JSON file with the model params")
    parser.add_argument("--config", type=str, help="user config JSON file with the model params")
